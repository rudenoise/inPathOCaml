...
(* OASIS_START *)
(* DO NOT EDIT (digest: b4851f4e939d82e007bbb41f8f29284b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "A simple CLI tool for finding sub-paths";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "inPath.ml"})
            ];
     ...
     oasis_digest = Some "\005\014\014I-\132\028\160\189\011p\195T`j\229";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
